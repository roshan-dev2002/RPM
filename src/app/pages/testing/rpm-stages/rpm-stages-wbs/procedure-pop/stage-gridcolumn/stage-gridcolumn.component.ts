...
@Component({
  selector: 'app-stage-gridcolumn',
  templateUrl: './stage-gridcolumn.component.html',
  styleUrls: ['./stage-gridcolumn.component.scss']
})
export class StageGridcolumnComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<StageGridcolumnComponent>,
