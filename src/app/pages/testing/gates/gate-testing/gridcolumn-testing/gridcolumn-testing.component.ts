...
@Component({
  selector: 'app-gridcolumn-testing',
  templateUrl: './gridcolumn-testing.component.html',
  styleUrls: ['./gridcolumn-testing.component.scss']
})
export class GridcolumnTestingComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<GridcolumnTestingComponent>,
