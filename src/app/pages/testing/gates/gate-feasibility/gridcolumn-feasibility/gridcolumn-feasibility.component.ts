...
@Component({
  selector: 'app-gridcolumn-feasibility',
  templateUrl: './gridcolumn-feasibility.component.html',
  styleUrls: ['./gridcolumn-feasibility.component.scss']
})
export class GridcolumnFeasibilityComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<GridcolumnFeasibilityComponent>,
