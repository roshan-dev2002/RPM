...
@Component({
  selector: 'app-gridcolumn-design',
  templateUrl: './gridcolumn-design.component.html',
  styleUrls: ['./gridcolumn-design.component.scss']
})
export class GridcolumnDesignComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<GridcolumnDesignComponent>,
