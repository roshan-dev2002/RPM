...
@Component({
  selector: 'app-gridcolumn-launch',
  templateUrl: './gridcolumn-launch.component.html',
  styleUrls: ['./gridcolumn-launch.component.scss']
})
export class GridcolumnLaunchComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<GridcolumnLaunchComponent>,
