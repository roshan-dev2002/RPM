...
@Component({
  selector: 'app-gridcolumn-prototyping',
  templateUrl: './gridcolumn-prototyping.component.html',
  styleUrls: ['./gridcolumn-prototyping.component.scss']
})
export class GridcolumnPrototypingComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<GridcolumnPrototypingComponent>,
